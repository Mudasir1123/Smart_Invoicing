...
export default function Contact() {
  ...
  const contactMethods = [
    {
      icon: Mail,
      title: 'Email',
      value: 'hello@smartinvoicing.com',
    ...
    },
    {
      ...
      description: 'Visit our headquarters or schedule a call',
    },
  ]
  ...
  return (
    <PageTransition>
      ...
      {/* Contact Hero */}
      <section className="relative pt-36 pb-12 px-6 lg:px-16 text-center">
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto font-medium leading-relaxed">
            Have questions about FBR integration or custom features? Contact our expert team for dedicated assistance.
          </p>
        </div>
      </section>
      ...
      <section className="pb-32 px-6 lg:px-16">
        <div className="mx-auto max-w-5xl">
          ...
          >
            {/* Left Column: Contact Methods / Brand Info */}
            <div className="md:col-span-5 p-8 md:p-12 relative flex flex-col justify-between overflow-hidden" style={{ background: 'linear-gradient(135deg, rgba(23,59,100,0.06), rgba(30,154,216,0.04))' }}>
                    ...
                    return (
                      <div key={index} className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] font-semibold text-muted-foreground/80 mt-0.5">{method.description}</p>
                        </div>
                      </div>
                    )
                  })}
              ...
              <div className="relative z-10 mt-12 p-5 rounded-2xl border border-blue-500/20 dark:border-blue-400/20 bg-white/35 dark:bg-slate-900/60 backdrop-blur-md">
                <p className="text-xs font-bold text-foreground">💡 Fast Turnaround</p>
                <p className="text-[11px] font-semibold text-muted-foreground mt-1 leading-relaxed">
                  Our onboarding specialists typically call back within 2 hours of inquiry during business hours.
                </p>
              </div>
            </div>

            {/* Right Column: Modern Contact Form */}
            <form onSubmit={handleSubmit} className="md:col-span-7 p-8 md:p-12 space-y-6 bg-white/40 dark:bg-black/20 border-l border-black/5 dark:border-white/5">
              ...
              {submitted && (
                <motion.div
                  ...
                  className="rounded-xl bg-[#00A266]/10 p-4 text-center text-xs font-bold text-[#00A266] border border-[#00A266]/20"
                >
