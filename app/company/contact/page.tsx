        ...
        <section className="pb-20 px-6 lg:px-16">
          <div className="mx-auto max-w-6xl">
            <motion.div
              ...
              className="grid grid-cols-1 md:grid-cols-12 rounded-[2rem] overflow-hidden glass-card shadow-2xl border will-change-transform"
            ...
            >
              ...
              <div className="relative z-10 p-12 text-center flex flex-col items-center">
                ...
                <motion.a
                  ...
                  className="inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-green-500 to-green-400 px-10 py-4 text-lg font-bold text-white shadow-[0_0_20px_rgba(34,197,94,0.4)] hover:shadow-[0_0_30px_rgba(34,197,94,0.6)] transition-all duration-300 will-change-transform"
                >
